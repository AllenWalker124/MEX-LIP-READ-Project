...
if __name__ == '__main__':
  ...
  model_name = 'mpdo_articulacion'

  num_classes = 6

  dataset_path = 'Dataset_TT/Modo de articulacion'
  ...
  early_stopping = EarlyStopping(monitor="val_accuracy", patience=100 , start_from_epoch=1, restore_best_weights=True)
#   model.summary()
